<section class="bg-light border-top border-bottom mt-auto">
    <div class="container py-4">
        <h1 class="fs-18 fw-700 text-gray-dark mb-3">
            Active eCommerce CMS | AN ONLINE SHOPPING PLATFORM WITH GREAT DEALS
        </h1>
        <p class="fs-13 text-gray-dark text-justify mb-0">
            Active eCommerce CMS Bangladesh is a leading online shopping site based in Bangladesh that brings you great
            deals, with platforms existing across Asia including Singapore, Thailand, Indonesia, Vietnam, Philippines,
            and Taiwan. We offer unbeatable deals featuring an endless range of products priced at affordable rates.
            What is even better? We enhance your experience with the eCommerce Guarantee, which means your payment is
            held in our system and only released to the seller after you have received your purchase in good condition!
            All because we value you as our customer. What are you waiting for? Come aboard and start browsing!<br />
            <br />
            Active eCommerce CMS -- QUALITY PRODUCTS, LOW PRICES<br />
            Active eCommerce CMS strives to provide you with a great online shopping experience and we know a great
            experience often includes affordable prices. That is why you should check out Active eCommerce CMS
            Bangladesh site/app’s daily online Shocking Sale, where we offer you different products at a discounted
            price, ensuring you get a bang for your buck. We even offer free shipping, Flat rate shipping, carrier-wise
            shipping on products! For brand-loyal customers, head over to Active eCommerce CMS Mall for authentic
            products at superb prices.<br />
            <br />
            Want to look your best without burning a hole in your wallet? Check out Style by Active eCommerce CMS for
            our top picks in fashion. Want to get the best prices for day-to-day items? Browse through our Lowest Price
            Guaranteed page. If you find the same Lowest Price Guaranteed item being sold at a lower price by a
            competitor, we will reward you with 120% of the price difference in Active eCommerce CMS Coins! You can also
            find official online stores for some of Bangladeshis biggest brands here, such as Nestle, Unilever, Mydin,
            Tefal, Calvin Klein, and more right here on our platform.<br />
            <br />
            Store FOR VARIETY WITH Active eCommerce CMS<br />
            Everyone loves online shopping for convenience and the low prices are a bonus! Active eCommerce CMS strives
            to help you get a bang for your buck with multiple sales and promotions happening at any one time. Make sure
            your wallet is ready for our big sales campaigns, such as 7.7 Orange Madness, 9.9 Super Shopping Day, 10.10
            Brands Festival, 11.11 Big Sale, and 12.12 Birthday Sale. We also have massive sales and offer great savings
            to you during major festivals like Chinese New Year and Raya! At the same time, check in often because we
            also have smaller sale periods that are category-specific, such as our Baby Fair and Black Friday
            sales.<br />
            <br />
            Let’s not forget about the frequently occurring Super Brand Day! These days, specific brands offer amazing
            deals for their top-selling items, so be sure to watch if your favorite brand is featured. Of course, there
            are always different kinds of smaller promotions happening every day, so you really will benefit if you
            constantly check your website to ensure you are not missing any mind-blowing offers!
        </p>
    </div>
</section>
        ...
        <div class="mt-3 mb-4">
            <a href="" class="d-block">
                <img class="lazyload h-45px"
                     src="https://demo.activeitzone.com/ecommerce/public/uploads/all/6TgLDR7srOHnPupxhYDsTSPzymj2OOlAxjXrEKI4.svg"
                     alt="" height="45">
            </a>
        </div>
        <div class="row">
            <div class="col-xl-6 col-lg-7">
                <div class="mb-4 text-secondary text-justify">
                            <span style="color: rgb(242, 243, 248); background-color:
                        rgb(17, 23, 35);">Complete system for your eCommerce business</span>
                </div>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-4">
                ...
                <ul class="list-inline social colored mb-4">
                    <li class="list-inline-item ml-2 mr-2">
                        <a href="" class="facebook d-flex align-items-center justify-content-center">
                            <img src="./images/icons/fb.png" width="16" height="16" alt="">
                        </a>
                    </li>
                    <li class="list-inline-item ml-2 mr-2">
                        <a href="" class="twitter d-flex align-items-center justify-content-center">
                            <img src="./images/icons/twt.png" width="16" height="16" alt="">
                        </a>
                    </li>
                    <li class="list-inline-item ml-2 mr-2">
                        <a href="" class="instagram d-flex align-items-center justify-content-center">
                            <img src="./images/icons/insta.png" width="16" height="16" alt="">
                        </a>
                    </li>
                    <li class="list-inline-item ml-2 mr-2">
                        <a href="" class="youtube d-flex align-items-center justify-content-center">
                            <img src="./images/icons/yt.png" width="16" height="16" alt="">
                        </a>
                    </li>
                    <li class="list-inline-item ml-2 mr-2">
                        <a href="" class="linkedin d-flex align-items-center justify-content-center">
                            <img src="./images/icons/in.png" width="16" height="16" alt="">
                        </a>
                    </li>
                </ul>
                ...
                <div class="d-flex mt-3">
                    <div class="">
                        <a href="" class="mr-2 mb-2 overflow-hidden hov-scale-img">
                            <img class="lazyload has-transition"
                                 src="https://demo.activeitzone.com/ecommerce/public/assets/img/play.png" alt=""
                                 height="44">
                        </a>
                    </div>
                    <div class="">
                        <a href="https://www.apple.com/app-store/" target="_blank"
                           class="overflow-hidden hov-scale-img">
                            <img class="lazyload has-transition"
                                 src="https://demo.activeitzone.com/ecommerce/public/assets/img/app.png" alt=""
                                 height="44">
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a href="https://demo.activeitzone.com/ecommerce/terms"
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <p class="fs-13 text-soft-light">Address</p>
                        </li>
                        <li class="mb-2">
                        ...
                        <li class="mb-2">
                            ...
                            <p class="">
                                <a href="" class="fs-13 text-soft-light hov-text-primary">demo@gmail.com</a>
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <a class="fs-13 text-soft-light animate-underline-white" href="">
                                Login
                            </a>
                        </li>
                        <li class="mb-2">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <p class="fs-13 text-soft-light mb-0">
                                Become A Seller
                                <a href="" class="fs-13 fw-700 text-secondary-base ml-2">Apply Now</a>
                            </p>
                        </li>
                        <li class="mb-2">
                            <a class="fs-13 text-soft-light animate-underline-white" href="">
                ...
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        <li class="mb-2 pb-2  active">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" href="">
                                Login
                            </a>
                        </li>
                        <li class="mb-2 pb-2 ">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mb-2 pb-2">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" target="_blank"
                               href="">
                                Download Delivery Boy App
                            </a>
                        </li>
                ...
                <div class="text-center text-lg-right">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item mr-3">
                            <img src="https://demo.activeitzone.com/ecommerce/public/uploads/all/NankP5emHOKcdCWqX6Bks1Qa63iDgoLA6WPGn7oe.webp"
                                 height="20" class="mw-100 h-auto" style="max-height: 20px" alt="Payment method">
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2"
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col-auto">
            <a href="" class="text-secondary d-block text-center pb-2 pt-3 px-3 ">
