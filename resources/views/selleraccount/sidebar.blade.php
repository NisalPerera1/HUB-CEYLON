            ...
            <div class="aiz-sidebar left c-scrollbar">
                <div class="aiz-side-nav-logo-wrap">
                    <div class="d-block text-center my-3">
                        ...
                        @auth
                                            ...
                                            <p class="text-primary"><a href="">{{ Auth::user()->email }}</a></p>  
                          @endauth
                    </div>
                </div>
                <div class="aiz-side-nav-wrap">
                    ...
                    <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('clothes.index') }}" class="aiz-side-nav-link ">
                                <i class="las la-bullhorn aiz-side-nav-icon"></i>
                                <span class="aiz-side-nav-text">Clothes</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                    ...
                    <div class="d-flex justify-content-around align-items-center align-items-stretch">
                        ...
                        <div class="aiz-topbar-item ml-2">
                            <div class="align-items-stretch d-flex dropdown " id="lang-change">
                                ...
                                <!-- JavaScript for Dynamic Translation -->
                                <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                                <script>
                                  document.querySelectorAll('.dropdown-item').forEach(item => {
    item.addEventListener('click', function() {
        let selectedLanguage = this.getAttribute('data-flag');

        // Make AJAX request to translate content
        fetch('/translate?language=' + selectedLanguage)
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var mainContent = document.querySelector('.aiz-content-wrapper');

    // Get the toggle button
    var toggleButton = document.querySelector('.aiz-mobile-toggler');

    // Add a click event listener to the toggle button
    toggleButton.addEventListener('click', function() {
        // Toggle the 'collapsed' class on the sidebar and 'expanded' class on the main content
